...
CURR_CONFIG = {
    ...
    "mutation_edit_size": [0, 0.04],  # range for one param to be mutated
    ...
    "selection_temp": 0.7,  # temp for selection of levels, high temp uniform sampling, low temp high likelyhood only for high regret levels 
